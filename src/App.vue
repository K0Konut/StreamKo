...
<template>
  <div class="app">
    ...
    <header class="topbar">
      ...
      <nav class="nav-links">
        <button class="nav-link is-active">Accueil</button>
        <button class="nav-link">Films</button>
        <button class="nav-link">Series</button>
        <button class="nav-link">Ma liste</button>
      </nav>
